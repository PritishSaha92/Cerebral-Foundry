...
dataset = load_dataset("Pritish92/arc-agi-prompts-train-test-split")['train']
...
training_args = SFTConfig(
    ...
    hub_model_id="Pritish92/arc-model-unsloth-slow-lr-three-epochs-2",
    push_to_hub=True,
)
...
model.push_to_hub("Pritish92/arc-model-unsloth")
tokenizer.push_to_hub("Pritish92/arc-model-unsloth") 