...
def main():
    ...
    if create_filtered_dataset:
        ...
        filter_and_upload_dataset(
            original_dataset_name="Pritish92/arc-agi-prompts",
            new_dataset_name="Pritish92/arc-agi-prompts-max-10k-tokens",
            max_tokens=10000
        )
    ...
    if create_split_dataset:
        ...
        create_train_test_split_dataset(
            original_dataset_name="Pritish92/arc-agi-prompts",
            new_dataset_name="Pritish92/arc-agi-prompts-train-test-split",
    ...
    dataset = load_dataset("Pritish92/arc-agi-prompts")['train']
